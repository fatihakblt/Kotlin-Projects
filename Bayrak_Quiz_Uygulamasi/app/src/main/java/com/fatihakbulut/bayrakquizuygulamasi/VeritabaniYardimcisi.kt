...
class VeritabaniYardimcisi(context:Context)
    ...
    override fun onCreate(db: SQLiteDatabase?) { // Kullanılacak tablonun tanımlanması
    ...
    override fun onUpgrade(db: SQLiteDatabase?, oldVersion: Int, newVersion: Int) { // Tabloda sorun olduğunda gerçekleştirilecek işlemler
